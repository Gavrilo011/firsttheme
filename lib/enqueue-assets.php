...
function _themename_assets() {
    ...
    wp_add_inline_style('_themename-stylesheet', $inline_style);

    wp_enqueue_script( '_themename-scrips', get_template_directory_uri() . '/dist/assets/js/bundle.js', array('jquery'), '1.0.0', true );
}
...
function _themename_admin_assets() {
    ...
    wp_enqueue_script( '_themename-admin-scrips', get_template_directory_uri() . '/dist/assets/js/admin.js', '1.0.0', array(), true );
}
